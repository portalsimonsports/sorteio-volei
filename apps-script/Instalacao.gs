...
function CONFIGURAR_SISTEMA_INICIAL(){
 ...
 definirConfig_('INDICE_HISTORICO_ATIVO','SIM','Atualiza o índice pelos campeonatos finalizados');
 definirConfig_('AJUSTE_HISTORICO_MAXIMO',2,'Variação histórica máxima para cima ou para baixo');
 definirConfig_('JOGOS_CONFIANCA_TOTAL',6,'Quantidade de jogos para o desempenho atingir peso integral');
 definirConfig_('PESO_HISTORICO_VITORIAS',0.55,'Peso de vitórias e derrotas no índice histórico');
 definirConfig_('PESO_HISTORICO_SETS',0.25,'Peso do saldo proporcional de sets');
 definirConfig_('PESO_HISTORICO_PONTOS',0.10,'Peso do saldo proporcional de pontos');
 definirConfig_('PESO_HISTORICO_COLOCACAO',0.10,'Peso de título, vice e terceiro lugar');
 definirConfig_('DESEMPATE_ADULTOS_IDADE','MAIOR_IDADE_MELHOR_PARCEIRO','Em igualdade de índice, o adulto mais velho recebe o parceiro de índice superior');
 definirConfig_('CHAVEAMENTO_POR_FORCA','ATIVO','Cabeças de chave distribuídas pelo índice total das duplas');
 ...
 definirConfig_('CHAVEAMENTO_7_DUPLAS','3_QUARTAS_1_DIRETA','Sete duplas: três quartas e a melhor cabeça de chave diretamente na semifinal');
