/** SORTEIO DE DUPLAS DE VÔLEI — V005 */
...
function exigirAdmin_(c){const e=props_().getProperty('ADMIN_KEY');if(!e)throw Error('Execute CONFIGURAR_SISTEMA_INICIAL no editor do Apps Script.');if(!c||!compararSeguro_(c,e))throw Error('Chave administrativa inválida.');}
